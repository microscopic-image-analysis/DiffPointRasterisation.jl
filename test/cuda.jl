...
@testitem "CUDA forward" begin
    ...
    # no projection
    args = (D.grid_size_3d, D.more_points, D.rotations_static, D.translations_3d_static, D.backgrounds, D.weights, D.more_point_weights)
    ...
    # projection
    args = (D.grid_size_2d, D.more_points, D.projections_static, D.translations_2d_static, D.backgrounds, D.weights, D.more_point_weights)
    @test cuda_cpu_agree(raster, args...) skip=!cuda_available
end
...
@testitem "CUDA backward" begin
    ...
    args = (ds_dout_3d, D.more_points, D.rotations_static, D.translations_3d_static, D.backgrounds, D.weights, D.more_point_weights)
    ...
    args = (ds_dout_2d, D.more_points, D.projections_static, D.translations_2d_static, D.backgrounds, D.weights, D.more_point_weights)
    @test cuda_cpu_agree(raster_pullback!, args...) skip=!cuda_available
end
