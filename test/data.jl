...
const translations_3d_reinterp = reinterpret(reshape, SVector{3, Float64}, translations_3d_array)
...
const translations_2d_reinterp = reinterpret(reshape, SVector{2, Float64}, translations_2d_array)
